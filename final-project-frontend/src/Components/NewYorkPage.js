...
const theme = {
  ...
  card: "#fff",
  border: "#e0e1dd",
  shadow: "rgba(47, 54, 64, 0.08)"
};

// 1 USD = 140 KES (example rate, update as needed)
const USD_TO_KES = 140;

const hotels = [
  {
    name: "The Plaza Hotel",
    description: "Historic luxury hotel at Central Park South, famous for its grandeur and service.",
    price: 500 * USD_TO_KES,
    images: [
  ...
  },
  {
    ...
    description: "Modern luxury hotel on Fifth Avenue with skyline views and fine dining.",
...
const slides = [
  {
    ...
    description: 'The vibrant heart of Manhattan, dazzling with lights and energy.'
  },
  {
    title: 'Central Park',
    image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=1200&q=80',
    description: 'An urban oasis for relaxation, recreation, and iconic city views.'
  }
];
          ...
          >
            ...
            <div style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              {showAuth && (
                ...
                >
                  <div style={{ background: '#fff', borderRadius: 12, padding: 24, minWidth: 320, boxShadow: '0 4px 32px #1a223333', position: 'relative' }}>
                    <button
