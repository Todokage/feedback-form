...
// 1 GBP = 180 KES (example rate, update as needed)
const GBP_TO_KES = 180;

const hotels = [
  {
    name: "The Ritz London",
    description: "Luxury 5-star hotel in Piccadilly, famous for its afternoon tea and classic British elegance.",
    price: 600 * GBP_TO_KES,
    images: [
  ...
  {
    name: "The Savoy",
    description: "Historic hotel on the Strand, offering river views, fine dining, and world-class service.",
    price: 800 * GBP_TO_KES,
    images: [
  ...
  {
    name: "The Langham",
    description: "Elegant hotel near Oxford Circus, known for its refined rooms, spa, and afternoon tea.",
    price: 500 * GBP_TO_KES,
    images: [
...
const slides = [
  {
    ...
    description: 'London’s most iconic clock tower and the seat of British government.'
  },
  {
    title: 'Tower Bridge',
    image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=1200&q=80',
    description: 'A symbol of London, this Victorian bridge offers panoramic views of the Thames.'
  },
  {
    title: 'Buckingham Palace',
    image: 'https://images.unsplash.com/photo-1501594907352-04cda38ebc29?auto=format&fit=crop&w=1200&q=80',
    description: 'The official residence of the British monarch and a must-see London landmark.'
  }
];
