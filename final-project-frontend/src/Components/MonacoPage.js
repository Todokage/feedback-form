...
const hotels = [
  ...
  },
  {
    ...
    description: "Elegant hotel with Mediterranean views and rooftop pool.",
...
const slides = [
  {
    ...
    description: 'Experience the glamour of Monaco’s world-famous casino.'
  },
  {
    title: 'Port Hercules',
    image: 'https://images.unsplash.com/photo-1464983953574-0892a716854b?auto=format&fit=crop&w=1200&q=80',
    description: 'Luxury yachts and stunning Mediterranean views.'
  }
];
          ...
          >
            ...
            <div style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              {showAuth && (
                ...
                >
                  <div style={{ background: '#fff', borderRadius: 12, padding: 24, minWidth: 320, boxShadow: '0 4px 32px #2d314233', position: 'relative' }}>
                    <button
