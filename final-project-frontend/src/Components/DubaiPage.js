...
// 1 AED = 36 KES (example rate, update as needed)
const AED_TO_KES = 36;

const hotels = [
  {
    name: "Atlantis The Palm",
    description: "Iconic luxury resort on Palm Jumeirah with world-class dining, waterpark, and aquarium.",
    price: 1200 * AED_TO_KES,
    images: [
  ...
  },
  {
    ...
    description: "Famous sail-shaped hotel offering ultra-luxury suites, private beach, and fine dining.",
  ...
  },
  {
    ...
    description: "Family-friendly resort with private beach, wave-shaped architecture, and multiple pools.",
    price: 900 * AED_TO_KES,
    images: [
...
const slides = [
  {
    ...
    description: 'The world’s tallest building and Dubai’s most iconic landmark.'
  },
  {
    title: 'Palm Jumeirah',
    image: 'https://images.unsplash.com/photo-1464983953574-0892a716854b?auto=format&fit=crop&w=1200&q=80',
    description: 'A man-made island shaped like a palm tree, home to luxury resorts and beaches.'
  },
  {
    ...
    description: 'Shop, dine, and enjoy the spectacular Dubai Fountain show at the world’s largest mall.'
  }
];
