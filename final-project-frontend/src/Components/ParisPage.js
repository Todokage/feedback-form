...
const theme = {
  ...
  card: "#fff",
  border: "#e0e1dd",
  shadow: "rgba(58, 35, 74, 0.08)"
};

// 1 EUR = 160 KES (example rate, update as needed)
const EUR_TO_KES = 160;

const hotels = [
  {
    name: "Le Meurice",
    description: "Elegant hotel near the Louvre with classic Parisian luxury.",
    price: 80 * EUR_TO_KES,
    images: [
  ...
  {
    name: "Hotel Lutetia",
    description: "Art Deco landmark on the Left Bank, luxury and history combined.",
    price: 65 * EUR_TO_KES,
    images: [
...
const slides = [
  {
    ...
    description: 'The symbol of Paris, sparkling every night.'
  },
  {
    title: 'Montmartre',
    image: 'https://images.unsplash.com/photo-1464983953574-0892a716854b?auto=format&fit=crop&w=1200&q=80',
    description: 'Art, cafes, and city views from Sacré-Cœur.'
  }
];
          ...
          >
            ...
            <div style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              {showAuth && (
                ...
                >
                  <div style={{ background: '#fff', borderRadius: 12, padding: 24, minWidth: 320, boxShadow: '0 4px 32px #3a234a33', position: 'relative' }}>
                    <button
